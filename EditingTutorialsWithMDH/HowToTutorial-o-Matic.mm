...
<node TEXT="Tutorial-o-Matic&#xa;How to&apos;s" LOCALIZED_STYLE_REF="AutomaticLayout.level.root" FOLDED="false" ID="ID_258304564" LINK="menuitem:_addons.tutorialOMatic.showTutorialsFromActiveMap_on_single_node" MAX_WIDTH="7 cm"><hook NAME="MapStyle" background="#c4e1ff">
    <properties show_icon_for_attributes="true" edgeColorConfiguration="#808080ff,#ff0000ff,#0000ffff,#00ff00ff,#ff00ffff,#00ffffff,#7c0000ff,#00007cff,#007c00ff,#7c007cff,#007c7cff,#7c7c00ff" mapUsesOwnSaveOptions="true" mdhCleanMindmapPath="C:\Users\Edo\Documents\GitHub\Freeplane_Tutorial_AddOn\Tutorial-o-Matic\zips\doc\Tutorial-o-Matic\HowToTutorial-o-Matic.mm" save_modification_times="false" mdhCleanMindmapExportDate="2022-05-06 11:22:37.289-0400" save_last_visited_node="default" show_note_icons="true" save_folding="save_folding_if_map_is_changed" fit_to_viewport="false"/>
...
<html>
  ...
  <body>
    <p>
      To create a new <u>mindmap that has the styles </u>needed to build a tutorial using <b>Tutorial-o-Matic</b>&nbsp;you can use the command &quot;<b>Create new tutorial mind map</b>&quot;.
    </p>
    <p>
...
<html>
  ...
  <body>
    <p>
      The text in the child nodes can be written using <b>plain text</b>, <b>Html</b>&nbsp;or <b>Markdown</b>, just as usual.
    </p>
    <p>
...
<html>
  ...
  <body>
    <p>
      <font color="#ff0000" size="6"><b>ToM_showMenu</b></font>
    </p>
  </body>
</html></richcontent>
</node>
...
<html>
  ...
  <body>
    <p>
      <font size="5"><b>How to (1): </b></font>
    </p>
    <p>
      <font color="#ff0000" size="6"><b>Add link to menu command </b></font>
    </p>
    <p>
      <font size="5"><b>(Manually) </b></font>
    </p>
  </body>
</html></richcontent>
</node>
...
Manual:&#xd;
&#xd;
* add a new node as child of the ToM_showMenu node&#xd;
* select it&#xd;
* use command &apos;Add hyperlink to menu item…&apos;&#xd;
</text>
</richcontent>
</node>
</node>
...
<html>
  ...
  <body>
    <p>
      <font size="5"><b>How to (2): </b></font>
    </p>
    <p>
      <font color="#ff0000" size="6"><b>&quot;Get menu command&quot; </b></font>
    </p>
    <p>
      <font size="5"><b>(Automatically) </b></font>
    </p>
  </body>
</html></richcontent>
</node>
...
&#xd;
For this to work the command must have defined hotkeys.&#xd;
&#xd;
Steps:&#xd;
&#xd;
* select the ToM_showMenu node&#xd;
* open the Freeplane Menu and place the mouse&#xd;
 arrow on the command you want (without clicking)&#xd;
* use the hotkeys to apply command &quot;Get menu command&quot;&#xd;
&#xd;
  &#xd;
</text>
</richcontent>
...
<html>
  ...
  <body>
    <p>
      <font color="#ff0000" size="6"><b>ToM_menuAction</b></font>
    </p>
  </body>
</html></richcontent>
</node>
...
&#xd;
* Add a node with style &quot;ToM_menuAction&quot;&#xd;
    * the text of its note is used as text in the panel&#xd;
    &#xd;
* Add child nodes with links to menu commands you want to show&#xd;
  * The text of that nodes are not used&#xd;
&#xd;
* When the user clicks on the &quot;Execute&quot; button&#xd;
  * all menu commands are executed in the same order as the child nodes&#xd;
  </text>
</richcontent>
</node>
</node>
...
&#xd;
* Present or not:&#xd;
  * **candle:** &lt;br&gt;indicates it executes only one time and &#xd;
gets disabled&#xd;
&#xd;
* One of these (or none):&#xd;
  * **computer mouse:** &lt;br&gt;should show the menu locations&#xd;
  * **keyboard:** (or no icon) &lt;br&gt;indicates it should &#xd;
show the Hotkeys &lt;br&gt;(if it hasn&apos;t a defined hotkey, &#xd;
then it shows the menu position)&#xd;
  * **muted speaker:** &lt;br&gt;indicates it should execute the &#xd;
commands without showing menus or hotkeys&#xd;
</text>
</richcontent>
</node>
</node>
...
<html>
  ...
  <body>
    <p>
      <font color="#ff0000" size="6"><b>ToM_groovy</b></font>
    </p>
  </body>
</html></richcontent>
</node>
...
to execute the code
* show the code and have a button 
to execute the code
* don&apos;t show any code but have a button 
to execute the code
...
&#xd;
* Add a node with style &quot;ToM_groovy&quot;&#xd;
    * the text of this node, its note &#xd;
    or details are not shown in the tutorial&#xd;
    &#xd;
* Add child nodes with groovy scripts&#xd;
  * The text of that nodes are used as the texts of the panels&#xd;
&#xd;
* When the user clicks on the &quot;Execute&quot; button&#xd;
  * the script in that node gets executed&#xd;
  </text>
</richcontent>
</node>
</node>
...
modifiers&#xd;
&#xd;
  * **glasses:** (read only)&lt;br&gt;&#xd;
  indicates that the groovy script is to be seen, &#xd;
  but it can&apos;t be executed (no button)&#xd;
  * **magnifying glass tilted left:** &lt;br&gt;&#xd;
  indicates that the script code must &#xd;
  be shown in the tutorial &#xd;
  * **candle:** &lt;br&gt;&#xd;
  indicates it executes only one time and &#xd;
gets disabled</text>
</richcontent>
</node>
</node>
...
<html>
  ...
  <body>
    <p>
      <font color="#ff0000" size="6"><b>ToM_goto</b></font>
    </p>
  </body>
</html></richcontent>
</node>
...
The steps are very similar to the &quot;menuAction&quot; case:&#xd;
&#xd;
* Add a node with style &quot;ToM_goto&quot;&#xd;
    * the text of this node, its note &#xd;
    or details are not shown in the tutorial&#xd;
    &#xd;
* Add child nodes with links to other &#xd;
ToM nodes in the same Mindmap&#xd;
...
&#xd;
  * **BACK arrow:** &lt;br&gt;&#xd;
  indicates that the target page has to have &#xd;
  a &quot;return&quot; panel, so the user can return &#xd;
...
<html>
  ...
  <body>
    <p>
      <font color="#ff0000" size="6"><b>ToM_copy</b></font>
    </p>
  </body>
</html></richcontent>
</node>
...
&#xd;
&#xd;
* Add a node with style &quot;ToM_copy&quot;&#xd;
    * the text of this node, its note &#xd;
    or details are not shown in the tutorial&#xd;
    &#xd;
* Add the node structure you want to be copied &#xd;
as descendants of that node&#xd;
&#xd;
  </text>
</richcontent>
</node>
...
<html>
  ...
  <body>
    <p>
      <font color="#ff0000" size="6"><b>ToM_select</b></font>
    </p>
  </body>
</html></richcontent>
</node>
...
&#xd;
&#xd;
* Add a node with style &quot;ToM_select&quot;&#xd;
    * the text of this node, its note &#xd;
    or details are not shown in the tutorial&#xd;
* Select the nodes you want to be selected&#xd;
* &quot;Copy node (single)&quot; them&#xd;
* Paste clones&#xd;
as descendants of the &quot;ToM_select&quot; node&#xd;
&#xd;
  </text>
</richcontent>
</node>
...
<html>
  ...
  <body>
    <p>
      <font color="#ff0000" size="6"><b>Create ToM_select node</b></font>
    </p>
  </body>
</html></richcontent>
</node>
...
<html>
  ...
  <body>
    <p>
      <font color="#ff0000" size="6"><b>&quot;Copy node (single)&quot;</b></font>
    </p>
  </body>
</html></richcontent>
</node>
...
<html>
  ...
  <body>
    <p>
      <font color="#ff0000" size="6"><b>Paste clone(s)</b></font>
    </p>
  </body>
</html></richcontent>
</node>
...
<html>
  ...
  <body>
    <p>
      <font color="#ff0000" size="6"><b>ToM_openMap</b></font>
    </p>
  </body>
</html></richcontent>
</node>
...
&#xd;
&#xd;
* Add a node with style &quot;ToM_openMap&quot;&#xd;
  * the text of this node, its note &#xd;
    or details are not shown in the tutorial&#xd;
    &#xd;
* Insert a child node indicating &#xd;
the mindmap&apos;s name in its text&#xd;
&#xd;
  </text>
</richcontent>
</node>
...
<html>
  ...
  <body>
    <p>
      <font color="#ff0000" size="6"><b>Create ToM_openMap node</b></font>
    </p>
  </body>
</html></richcontent>
</node>
...
<html>
  ...
  <body>
    <p>
      <font color="#ff0000" size="6"><b>ToM_openTutMap</b></font>
    </p>
  </body>
</html></richcontent>
</node>
...
&#xd;
&#xd;
* Add a node with style &quot;ToM_openTutMap&quot;&#xd;
  * the text of this node, its note &#xd;
    or details are not shown in the tutorial&#xd;
    &#xd;
&#xd;
...
<html>
  ...
  <body>
    <p>
      <font color="#ff0000" size="6"><b>Create ToM_openTutMap&nbsp;node</b></font>
    </p>
  </body>
</html></richcontent>
</node>
...
<html>
  ...
  <body>
    <p>
      <font color="#ff0000" size="6"><b>ToM_showNode</b></font>
    </p>
  </body>
</html></richcontent>
</node>
...
&#xd;
* Add a node with style &quot;ToM_showNode&quot;&#xd;
    * the text of this node, its note &#xd;
    or details are not shown in the tutorial&#xd;
    &#xd;
* Add child nodes with links to other&#xd;
 nodes in the same or another Mindmap&#xd;
  * The text of that nodes are used as the texts &#xd;
  of the panels&#xd;
&#xd;
&#xd;
...
<html>
  ...
  <body>
    <p>
      <font color="#ff0000" size="6"><b>Create ToM_showNode&nbsp;node</b></font>
    </p>
  </body>
</html></richcontent>
</node>
