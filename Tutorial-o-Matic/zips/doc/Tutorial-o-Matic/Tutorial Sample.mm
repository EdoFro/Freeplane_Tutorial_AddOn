...
<node TEXT="text with code" ID="ID_414113888"><richcontent TYPE="NOTE" CONTENT-TYPE="plain/markdown">
...
<node TEXT="table example" ID="ID_1393870240"><richcontent TYPE="NOTE" CONTENT-TYPE="plain/markdown">
    <text>## a link and an image&#xd;
&#xd;
-----&#xd;
&#xd;
For more information look: [Freeplane Homepage](https://www.freeplane.org/wiki/index.php/Home)&#xd;
&#xd;
![What is Mindmapping (thumb)](https://www.freeplane.org/wiki/images/thumb/7/7b/WhatIsMindMapping.jpg/300px-WhatIsMindMapping.jpg)</text>
</richcontent>
</node>
</node>
...
<node TEXT="view" ID="ID_43965285"><richcontent TYPE="NOTE" CONTENT-TYPE="plain/markdown">
    <text>## Menu View&#xd;
&#xd;
Too many  toolbars on screen? Do you want to have a bigger look of your map?&#xd;
&#xd;
 * No problem! you can use the **Fullscreen mode**!!&#xd;
&#xd;
&#xd;
The **Outline view** can give you a different way to look at your map&#xd;
&#xd;
&#xd;
### Do you want to try them? Here is how:</text>
</richcontent>
</node>
</node>
<node TEXT="show menu commands" STYLE_REF="ToM_showMenu" ID="ID_1795456353">
<node TEXT="Full screen mode" ID="ID_16960604" LINK="menuitem:_ToggleFullScreenAction"/>
<node TEXT="Outline view" ID="ID_1457230811" LINK="menuitem:_ViewLayoutTypeAction.OUTLINE"/>
</node>
<node TEXT="text" STYLE_REF="ToM_note" ID="ID_1243710212">
<node TEXT="Blinking" ID="ID_628746509"><richcontent TYPE="NOTE" CONTENT-TYPE="plain/markdown">
    <text>## Blinking node&#xd;
&#xd;
You can also apply a multicolor, eye catching format to your node using the **Blinking node** command&#xd;
</text>
</richcontent>
</node>
</node>
<node TEXT="show menu commands" STYLE_REF="ToM_showMenu" ID="ID_1019301126">
<node TEXT="Blinking node" ID="ID_1158731311" LINK="menuitem:_BlinkingNodeHookAction"/>
</node>
<node TEXT="text" STYLE_REF="ToM_note" ID="ID_659682608">
<node TEXT="Bold" ID="ID_1526021839"><richcontent TYPE="NOTE" CONTENT-TYPE="plain/markdown">
    <text>## Using hotkeys&#xd;
&#xd;
Some of the commands can be called by clicking in the manu but also by using Hotkeys.&#xd;
&#xd;
### Here is an example:&#xd;
</text>
</richcontent>
...
&#xd;
Just add nodes to it and change their styles to the ones that you can find in the styles menu that start with &quot;ToM_&quot;</text>
</richcontent>
</node>
</node>
<node TEXT="show menu commands" STYLE_REF="ToM_showMenu" ID="ID_210491771">
<node TEXT="ToM_note" ID="ID_613040870" LINK="menuitem:_AssignStyleAction.ToM_note"/>
</node>
<node TEXT="text" STYLE_REF="ToM_note" ID="ID_1462257095">
<node TEXT="User directory" ID="ID_1075011286"><richcontent TYPE="NOTE" CONTENT-TYPE="plain/markdown">
    <text>## Where are all configuration files, addons, etc saved?

in Freeplane&apos;s user directory.

### You can open it directly using a menu command:</text>
</richcontent>
</node>
</node>
<node TEXT="show menu commands" STYLE_REF="ToM_showMenu" ID="ID_1828173023">
...
<node TEXT="next steps" ID="ID_1596967423"><richcontent TYPE="NOTE" CONTENT-TYPE="plain/markdown">
    <text>## Next steps&#xd;
&#xd;
* Way to execute menu commands on the selected node (almost ready)&#xd;
* Insert an example node structure to the example map (30%)&#xd;
